...
# 3. GET-запрос на /lenet/train запустит обучение сети на наборе рукописных цифр MNIST или на своём предварительно созданном наборе данных data/training_sample.npz
