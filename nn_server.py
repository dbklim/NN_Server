...
@auth.login_required
def list_nn():
    ''' Возвращает список имеющихся нейронных сетей с небольшим описанием и их адресами. '''
...
# Всего 3 запроса:
# 1. GET-запрос на /lenet/about, вернёт информацию о сети LeNet
# 2. GET-запрос на /lenet/training запустит обучение сети на обучающей выборке MNIST
# 3. POST-запрос на /lenet/classification принимает .jpg/.png/.bmp/.tiff файл и возвращает распознанную цифру
